...
export function useServiceWorker(): ServiceWorkerState {
  ...
  useEffect(() => {
    ...
    // Reload only when the user explicitly triggered a SW update (skipWaiting).
    // Do NOT reload on first-install controllerchange — that would reset the
    // page for brand-new users (e.g. mid-registration form).
