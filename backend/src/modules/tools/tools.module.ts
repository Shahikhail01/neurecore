...
import {
  ...
  SearchAgentsTool,
  GetCustomerProjectsTool,
  ListCustomerContactsTool,
  ListAllNotificationsTool,
  GetActivityFeedTool,
  ListMyApprovalHistoryTool,
  SearchTasksTool,
  GetTaskStatsTool,
  GlobalSearchTool,
...
export class ToolsModule implements OnModuleInit {
  constructor(
    ...
    private readonly listProjects: ListProjectsTool,
    private readonly searchProjects: SearchProjectsTool,
    private readonly getProjectByName: GetProjectByNameTool,
    private readonly updateProjectStatus: UpdateProjectStatusTool,
    private readonly addProjectMember: AddProjectMemberTool,
    private readonly removeProjectMember: RemoveProjectMemberTool,
    private readonly listProjectMembers: ListProjectMembersTool,
    private readonly listProjectStages: ListProjectStagesTool,
    private readonly updateProjectStage: UpdateProjectStageTool,
    private readonly listWorkflows: ListWorkflowsTool,
    private readonly getWorkflow: GetWorkflowTool,
    private readonly listGoals: ListGoalsTool,
    private readonly updateGoalProgress: UpdateGoalProgressTool,
    private readonly listBudgetPolicies: ListBudgetPoliciesTool,
    private readonly getDepartment: GetDepartmentTool,
    private readonly listDepartmentMembers: ListDepartmentMembersTool,
    private readonly listAgentsByDepartment: ListAgentsByDepartmentTool,
    private readonly searchAgents: SearchAgentsTool,
    private readonly getCustomerProjects: GetCustomerProjectsTool,
    private readonly listCustomerContacts: ListCustomerContactsTool,
    private readonly listAllNotifications: ListAllNotificationsTool,
    private readonly getActivityFeed: GetActivityFeedTool,
    private readonly listMyApprovalHistory: ListMyApprovalHistoryTool,
