...
exports.SUB_INDUSTRY_AGENT_PRIORITIES = exports.INDUSTRY_GROUP_INDUSTRIES = exports.ACTIVE_INDUSTRY_GROUPS = exports.INDUSTRY_GROUP = void 0;
exports.resolveDefaultAgentsForIndustry = resolveDefaultAgentsForIndustry;
 ...
 */
exports.ACTIVE_INDUSTRY_GROUPS = new Set([
    exports.INDUSTRY_GROUP.FINANCIAL_COMPLIANCE,
    exports.INDUSTRY_GROUP.BUSINESS_TECHNOLOGY,
    exports.INDUSTRY_GROUP.CONSUMER_COMMERCE,
    exports.INDUSTRY_GROUP.PUBLIC_SOCIAL,
    exports.INDUSTRY_GROUP.OTHER,
]);
// ─── Industry Group → Industry Slugs ──────────────────────────────────────
exports.INDUSTRY_GROUP_INDUSTRIES = {
 ...
 */
exports.SUB_INDUSTRY_AGENT_PRIORITIES = {
 ...
 */
function resolveDefaultAgentsForIndustry(industrySlug) {
    const base = INDUSTRY_DEFAULT_AGENTS[industrySlug] ?? [];
    if (base.length === 0)
        return [];
    const priorities = exports.SUB_INDUSTRY_AGENT_PRIORITIES[industrySlug];
...
function getCapabilityMatrix(group, tier) {
    const baseMax = {
    ...
    const primaryIndustry = exports.INDUSTRY_GROUP_INDUSTRIES[group][0];
