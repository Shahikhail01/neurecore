...
const QUICK_LINKS = [
  {
    ...
    href: "/tenants",
    icon: "⬟",
    color: "border-indigo-700/40 hover:border-indigo-500/60",
  },
  {
    label: "Users",
    href: "/users",
  ...
  },
  {
    ...
    href: "/agents",
    icon: "◈",
    color: "border-violet-700/40 hover:border-violet-500/60",
  },
  {
    label: "Models",
    href: "/models",
    icon: "⬡",
    color: "border-cyan-700/40 hover:border-cyan-500/60",
  },
  {
    label: "Monitoring",
    href: "/monitoring",
...
export default function OverviewPage() {
  ...
  const { data: taskData, loading: taskLoading } = usePlatformChartData(
    "tasks",
    range,
  );
  const { data: agentData, loading: agentLoading } = usePlatformChartData(
    "agents",
    range,
  );
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-0.5">
            Mission control for the NeureCore platform
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KpiTile
            ...
            value={kpis?.runningAgents ?? "—"}
            delta={kpis?.totalAgents}
            deltaLabel="total"
            color="strategy"
            loading={kpisLoading}
          />
                ...
                {tenants.map((t) => (
                  ...
                  >
                    <td className="px-4 py-2.5 text-sm">
                      <Link
                        href={`/tenants/${t.id}`}
                        className="text-zinc-200 hover:text-indigo-400 transition"
                      >
                        {t.name}
                      </Link>
                    </td>
